...
class QuickstartUser(HttpUser):
    ...
    def check_rejected_drive(self):
        rejected_drive = self.client.get(f'/drives/get-rejected-drive', json=self.chosen_driver).json()
